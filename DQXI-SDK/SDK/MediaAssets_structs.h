...
{
	struct FText                                       DisplayName;                                              // 0x0000(0x0018) (BlueprintVisi, BlueprintReadOnly, Transient)
	struct FString                                     URL;                                                      // 0x0018(0x0010) (BlueprintVisi, BlueprintReadOnly, ZeroConstructor, Transient)
};
